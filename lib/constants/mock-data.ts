...
export const TESTIMONIALS_DATA = [
  {
    ...
    author: "Charles Boes",
    company: "Foodvisor",
    color: "border-border hover:border-emerald-500/30 hover:shadow-[0_15px_30px_rgba(16,185,129,0.08)]",
  ...
  },
  {
    ...
    author: "Francescu",
    company: "MOJO",
    color: "border-border hover:border-amber-500/30 hover:shadow-[0_15px_30px_rgba(245,158,11,0.08)]",
  ...
  },
  {
    ...
    company: "Audm",
    color: "border-border hover:border-blue-500/30 hover:shadow-[0_15px_30px_rgba(59,130,246,0.08)]",
