...
import { ShieldCheck, ShieldAlert, Award, FileText, ArrowRight } from "lucide-react";
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-gradient-to-br from-slate-900 to-indigo-950 text-white rounded-2xl p-6 md:p-8 shadow-xl flex flex-col justify-between border border-slate-800">
                <div className="space-y-4">
                  <div className="size-10 rounded-lg bg-[#00c9db]/10 text-[#00c9db] flex items-center justify-center">
                ...
                <div className="mt-4 pt-4 border-t border-slate-800 text-[11px] text-[#00c9db] font-semibold font-mono">
