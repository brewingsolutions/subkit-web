...
const BENEFITS: BenefitCard[] = [
  {
    title: "Portable Product Model",
    description: "A planned, versioned model for products, offerings, and entitlements that can run on infrastructure you control.",
    icon: SlidersHorizontal,
    iconBg: "bg-blue-500/10",
    iconColor: "text-blue-600",
  },
  {
    title: "Open SDK Direction",
    description: "Native and cross-platform SDKs are planned as public, auditable clients of a stable SDK Runtime contract.",
    icon: Zap,
  ...
  },
  {
    ...
    description: "Self-hosting can support data-residency and processor-control strategies when paired with appropriate operational and legal safeguards.",
    icon: ShieldCheck,
  ...
  },
  {
    ...
    description: "The Apache-2.0 Core foundation is designed for portable operation with documented data stores, migrations, and OCI-compatible container packaging.",
    icon: Database,
    iconBg: "bg-purple-500/10",
    iconColor: "text-purple-600",
  },
  {
    title: "Auditable Subscription State",
    description: "The roadmap separates immutable store events from derived subscription and entitlement state for traceable reconciliation.",
    icon: Users,
  ...
  },
  {
    ...
    description: "The early Event Inbox foundation supports deduplication, worker claims, completion, and retry across portable storage adapters.",
    icon: Webhook,
