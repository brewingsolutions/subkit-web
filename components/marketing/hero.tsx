...
import { SUPPORTED_PLATFORMS, TYPEWRITER_WORDS } from "@/lib/constants/marketing";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-7 text-left flex flex-col justify-center">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight text-card-foreground sm:text-6xl lg:text-7xl min-h-[160px] sm:min-h-[180px] lg:min-h-[220px] font-heading leading-tight">
              ...
              <span className="relative inline-block pb-3 pt-1 px-1 bg-gradient-to-r from-blue-600 via-primary to-[#ec72e2] bg-clip-text text-transparent">
                {typedText || "\u00A0"}
              </span>
              <br />
          ...
          <div className="lg:col-span-5 flex justify-center w-full">
            <div className="relative w-full max-w-lg rounded-2xl border border-white/10 bg-slate-900/95 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.4)] backdrop-blur-xl overflow-hidden group">
              <div className="absolute inset-0 bg-gradient-to-tr from-[#635bff]/5 to-transparent -z-10" />
